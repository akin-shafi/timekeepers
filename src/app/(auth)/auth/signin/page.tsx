...
import { Clock, ShieldCheck, ArrowRight, Lock, Sparkles, CheckCircle2, AlertTriangle, Loader2 } from "lucide-react";
      ...
      <div className="max-w-md w-full space-y-8 glass-panel p-8 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl text-sm font-semibold text-slate-900 bg-white hover:bg-slate-100 transition-all shadow-lg hover:shadow-cyan-500/10 active:scale-[0.99] border border-gray-200 dark:border-transparent disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isLoading ? (
